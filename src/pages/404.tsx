    ...
    <Layout>
      <div className='contact_hero--header h-[856px] sm:h-[896px]'>
        ...
        <div className='flex items-center justify-center flex-wrap max-w-[550px] m-auto mb-24'>
          <a href="/">
            <button 
              className='w-[190px] mx-2 mt-5 text-lg bold bg-bleu-foncé py-2 text-white rounded-[5px] effet-bleu tracking-wide'>
              Accueil
            </button>
          </a>
          ...
          <a href="/programmes">
            <button 
              className='w-[190px] mx-2 mt-5 text-lg bold bg-orange py-2 text-white rounded-[5px] effet-orange tracking-wide'>
              Programmes
            </button>
          </a>
          ...
          <a href="/contact">
            <button 
              className='flex items-center justify-center w-[190px] mx-2 mt-5 text-lg bold bg-gris-contour py-2 text-white rounded-[5px] tracking-wide'>
