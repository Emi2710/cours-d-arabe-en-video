...
import { sendContactForm } from "../lib/bug-api";
...
export default function BugContactForm() {
  ...
  return (
    <Container className='mb-28 flex flex-col items-center justify-center'>
      ...
      <FormControl 
        ...
        <FormLabel className='bold mb-3'>Votre email</FormLabel>
        <Input
      ...
      <FormControl
        ...
        className=''
      >
        <FormLabel className='bold mb-3 mt-8'>Ce que vous souhaitez signaler</FormLabel>
        <Textarea
