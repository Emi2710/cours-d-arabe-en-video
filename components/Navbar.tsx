        ...
        <div className={'information-dropdown flex flex-col absolute right-16 bg-white z-30 effet-orange'  +
            ...
            <div>
                ...
                <div className='socials flex justify-center items-center mt-10'>
                    ...
                    <Link href="https://x.com/coursvideo?s=11&t=7B3VSoYz1fxWBm2EVLVHxw" className='pr-5'>
                        <svg width="36" height="35" viewBox="0 0 36 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <Link href="https://instagram.com/abd_ar_rahman_abu_imran?igshid=MzRlODBiNWFlZA==">
